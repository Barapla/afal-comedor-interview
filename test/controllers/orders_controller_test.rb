...
class OrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "race condition: solo una orden tiene éxito cuando dos usuarios ordenan el último platillo" do
    @mi.update!(stock: 1)

    user2 = User.create!(
      email_address: "second-user@test.com",
    ...
    threads = [
      Thread.new do
        ...
        rescue OrdersController::InsufficientStockError, ActiveRecord::RecordNotUnique
          :failed
        end
      end,
      Thread.new do
    ...
    assert_includes results, :success
